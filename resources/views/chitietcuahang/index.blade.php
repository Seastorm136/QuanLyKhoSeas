    ...
    <div class="container-fluid">
        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('chi-tiet-cua-hang.index') }}" class="mb-4">
                    <div class="input-group">
                        ...
                        <a href="{{ route('chi-tiet-cua-hang.index') }}" class="btn btn-outline-secondary">Xóa</a>
                    </div>
                </form>
                        ...
                        <thead class="table-dark">
                            <tr>
                                <th scope="col" class="text-nowrap">
                                    <a href="{{ route('chi-tiet-cua-hang.index', [$cuaHang->ma_cua_hang, 'sort' => 'ma_sp', 'direction' => $sortColumn == 'ma_sp' && $sortDirection == 'asc' ? 'desc' : 'asc', 'search' => $search]) }}" class="text-white text-decoration-none">
                        ...
                        <tbody>
                            @forelse($chiTietCuaHangs as $chiTiet)
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <a href="{{ route('san-pham.staff_store_show', ['ma_cua_hang' => $chiTiet->ma_cua_hang, 'ma_sp' => $chiTiet->ma_sp]) }}" class="btn btn-sm btn-info">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                        </div>
                                    </td>
