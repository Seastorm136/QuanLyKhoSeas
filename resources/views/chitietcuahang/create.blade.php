            ...
            <div class="col-md-8 col-lg-6">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-danger text-white text-center">
                        <h2 class="mb-0 fs-4"><i class="bi bi-plus-circle me-2"></i>Thêm sản phẩm</h2>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('chi-tiet-cua-hang.store') }}">
                            @csrf
                            <input type="hidden" name="ma_cua_hang" value="{{ $cuaHang->ma_cua_hang }}">
                            <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <a href="{{ route('cua-hang.show', $cuaHang->ma_cua_hang) }}" class="btn btn-secondary">
