            ...
            <div class="col-md-12">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-danger text-white text-center">
                        <h2 class="mb-0 fs-4"><i class="bi bi-file-earmark-text me-2"></i>Báo cáo chi kho</h2>
                    </div>
                    <div class="card-body">
                        <form method="GET" action="{{ route('bao-cao.chi_kho') }}" class="mb-3">
                            <div class="row">
                                <div class="col-md-4">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td>{{ number_format($chiKho->sum('so_tien'), 0, ',', '.') }}</td>
                                    <td></td>
                                </tr>
                            </tfoot>
                        </table>
