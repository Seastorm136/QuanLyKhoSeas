            ...
            <div class="col-md-8 col-lg-6">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-danger text-white text-center">
                        <h2 class="mb-0 fs-4"><i class="bi bi-pencil-square me-2"></i>Sửa số lượng sản phẩm trong kho</h2>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('chi-tiet-kho-hang.update', [$chiTiet->ma_kho, $chiTiet->ma_sp]) }}">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                                <label for="ma_kho" class="form-label fw-bold">Mã kho</label>
                                <input type="text" name="ma_kho" id="ma_kho" class="form-control" value="{{ $chiTiet->ma_kho }}" disabled>
                            </div>
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <a href="{{ route('kho-hang.show', $chiTiet->ma_kho) }}" class="btn btn-secondary">
