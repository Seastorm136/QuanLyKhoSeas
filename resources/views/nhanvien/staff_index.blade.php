...
@section('content')
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <a href="{{ route('nhan-vien.staff_edit', $nhanVien->ma_nv) }}" class="btn btn-warning me-2">
                    <i class="fas fa-edit me-2"></i>Cập nhật thông tin
                </a>
                @if($nhanVien->chuc_vu === 'Nhân viên kho')
                    <a href="{{ route('home_warehouse') }}" class="btn btn-outline-secondary">
                        <i class="fas fa-arrow-left me-2"></i>Quay lại
                    </a>
                @elseif($nhanVien->chuc_vu === 'Nhân viên bán hàng')
                    <a href="{{ route('home_store') }}" class="btn btn-outline-secondary">
                        <i class="fas fa-arrow-left me-2"></i>Quay lại
                    </a>
                @endif
            </div>
